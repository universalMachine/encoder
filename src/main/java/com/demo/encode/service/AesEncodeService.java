...
@Service
public class AesEncodeService implements EncodeService {
    ...
    public AesEncodeService() throws UnsupportedEncodingException, NoSuchPaddingException, NoSuchAlgorithmException {
